...
const Project3Card: React.FC = () => (
  <>
    <img src="/images/awsphere.png" alt="AWSphere" className="w-full h-80 object-cover rounded-xl mb-4 border border-white/30 shadow-md mt-0" />
    <div className="w-full flex flex-col items-start justify-start pl-2">
      <h3 className="text-2xl md:text-3xl font-semibold text-left mb-2 tracking-wide bg-gradient-to-r from-blue-400 via-green-400 to-blue-400 bg-[length:200%_200%] bg-clip-text text-transparent animate-gradient-x flex items-center">
        AWSphere
        <a
          href="https://github.com/SHASHI9705/Blogit"
          target="_blank"
        ...
        <a
          href="https://www.linkedin.com/feed/update/urn:li:activity:7315308063702355969/"
          target="_blank"
          rel="noopener noreferrer"
          className="ml-2 flex items-center justify-center w-10 h-10 rounded-full bg-blue-500/30 border border-blue-400/40 hover:bg-yellow-400/30 transition-colors duration-200 shadow transform hover:scale-110"
          style={{marginBottom: '-2px'}}
      ...
      <p className="text-sm md:text-base text-gray-100 text-left leading-relaxed font-normal">AWSphere is a cloud-focused blogging platform where users can create accounts, write AWS-related blogs, comment, and manage their posts. It’s built to foster a collaborative community for sharing AWS knowledge and practical insights.</p>
