...
const Project4Card: React.FC = () => (
  <>
    <img src="/images/ec2cost.png" alt="EC2 Cost Optimizer" className="w-full h-80 object-cover rounded-xl mb-4 border border-white/30 shadow-md mt-0" />
    <div className="w-full flex flex-col items-start justify-start pl-2">
      <h3 className="text-2xl md:text-3xl font-semibold text-left mb-2 tracking-wide bg-gradient-to-r from-blue-400 via-green-400 to-blue-400 bg-[length:200%_200%] bg-clip-text text-transparent animate-gradient-x flex items-center">
        EC2 Cost Optimizer
        <a
          href="https://github.com/SHASHI9705/Cost-Optimization"
          target="_blank"
        ...
        <a
          href="https://www.linkedin.com/feed/update/urn:li:activity:7337345468533784576/"
          target="_blank"
          rel="noopener noreferrer"
          className="ml-2 flex items-center justify-center w-10 h-10 rounded-full bg-blue-500/30 border border-blue-400/40 hover:bg-yellow-400/30 transition-colors duration-200 shadow transform hover:scale-110"
          style={{marginBottom: '-2px'}}
      ...
      <p className="text-sm md:text-base text-gray-100 text-left leading-relaxed font-normal">Automated EC2 Cost Optimizer is a serverless solution that monitors EC2 usage and auto-stops idle instances to reduce cloud costs. Built with AWS Lambda, CloudWatch, and SNS, it helps automate cost governance and improve AWS efficiency.</p>
      <div className="mt-4 flex flex-wrap gap-2">
        <div className="inline-block px-5 py-1.5 bg-black text-blue-100 font-semibold text-sm rounded-full shadow select-none">EC2</div>
        <div className="inline-block px-5 py-1.5 bg-black text-blue-100 font-semibold text-sm rounded-full shadow select-none">Cloud Watch</div>
        <div className="inline-block px-5 py-1.5 bg-black text-blue-100 font-semibold text-sm rounded-full shadow select-none">AWS Lambda</div>
        <div className="inline-block px-5 py-1.5 bg-black text-blue-100 font-semibold text-sm rounded-full shadow select-none">IAM</div>
      </div>
    </div>
  </>
);
