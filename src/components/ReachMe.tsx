...
const ReachMe: React.FC = () => {
  return (
    <>
      ...
      <div className="w-full border-t border-white/20 mt-0 py-3 flex items-center justify-center bg-transparent text-xs sm:text-sm text-gray-400 font-semibold tracking-wide">
        Developed by Shashiranjan Singh &nbsp; <span className="text-lg align-middle">&copy;</span> 2025 All rights reserved.
      </div>
    </>
  );
};
