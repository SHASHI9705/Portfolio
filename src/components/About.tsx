        ...
        <div className="w-full md:w-[55%] bg-white/5 rounded-xl p-8 shadow-lg flex flex-col items-start border border-white">
          ...
          <div className="flex flex-col gap-6 mt-2 w-full">
            ...
            <div className="flex items-center gap-4 group cursor-pointer transition-transform duration-300 hover:scale-105">
              <span className="flex items-center justify-center w-12 h-12 rounded-full bg-gradient-to-r from-blue-400 via-green-400 to-blue-400 animate-gradient-x p-[2px] transition-shadow duration-300 group-hover:shadow-lg group-hover:shadow-blue-400/40">
            ...
            {/* Cloud Computing */}
            <div className="flex items-center gap-4 group cursor-pointer transition-transform duration-300 hover:scale-105">
              <span className="flex items-center justify-center w-12 h-12 rounded-full bg-gradient-to-r from-blue-400 via-green-400 to-blue-400 animate-gradient-x p-[2px] transition-shadow duration-300 group-hover:shadow-lg group-hover:shadow-green-400/40">
                <span className="flex items-center justify-center w-11 h-11 rounded-full bg-black transition-transform duration-300 group-hover:scale-110">
